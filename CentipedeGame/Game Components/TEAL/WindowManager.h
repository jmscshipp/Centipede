...
public:
	...
	static void SetWindowSize(int widthinPx, int heightInPx);
	...
	///		}
	///		\endcode
	static sf::Vector2f MousePosition(){ return static_cast<sf::Vector2f>( sf::Mouse::getPosition(Instance().MainWindow )); }

	static sf::RenderWindow& Window() { return Instance().MainWindow; }
};
